                ...
                <ul className="flex list-style-none">
                    ...
                    {allPages.map((page, index) => (
                        ...
                        <li key={page + '-' + index} className="page-item">
                            <Link
                                className={
                                    clsx("page-link relative block py-1.5 px-3  border-0 outline-none transition-all duration-300  text-gray-800 hover:text-gray-800 hover:bg-gray-200 focus:shadow-none rounded",
                                        {
